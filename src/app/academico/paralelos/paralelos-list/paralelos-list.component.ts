...
@Component({
  selector: 'app-paralelos-list',
  templateUrl: './paralelos-list.component.html',
  styleUrls: ['./paralelos-list.component.scss']
})
export class ParalelosListComponent implements OnInit{
